 ...
 try:
  ...
  #print(update)
   ...
   if update[0][6]=='R5 2600':
       write_msg(user_id,
                        'Тот же 1600, но уже 2-ое поколение, да и стоит дороже. Скрина нет')
   if update[0][6]=='R5 2600x':
       write_msg(user_id,
                        '2600 c разгоном')
   if update[0][6] == 'R7 1700':
      write_msg_attach(user_id,
                   'Топовое решение',
                   'photo261166398_456239991')
   if update[0][6]=='1':
      write_msg(user_id,
   ...
   if update[0][6] == '5':
        write_msg(user_id,
                      'Сокет АМ4: 200GE, R3 1200, R3 1300x, R3 2200G, R5 1400, R5 2400G, R5 1500x, R5 1600, R5 1600x, R5 2600, R5 2600x, R7 1700')
   else:
       write_msg(user_id,
